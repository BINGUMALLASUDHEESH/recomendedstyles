      ...
      <ScrollView contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.titleContainer}>
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('OutfitDetailsScreen2')}
          >
        ...
        <View style={styles.imageGrid}>
          ...
          <View style={styles.leftColumn}>
            <View style={styles.productContainer}>
              <View style={styles.imageWrapper}>
                <Image
                  source={require('../assets/accessaries3.png')}
            ...
            <View style={[styles.productContainer, styles.sunglassesContainer]}>
              <View style={styles.imageWrapper}>
                <Image
                  source={require('../assets/footwear3.png')}
          ...
          <View style={styles.rightColumn}>
            ...
            <View style={styles.productContainer}>
              <View style={styles.imageWrapper}>
                <Image
                  source={require('../assets/footwear9.png')}
...
export default AccessoriesScreen2;