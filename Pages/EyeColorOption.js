...
const EyeColorOption = ({ navigation,route  }) => {
    const { hairColor } = route.params;
  ...
  const handleNextPress = () => {
    if (selectedColor) {
      navigation.navigate('UnderToneColor',{ hairColor: hairColor, eyeColor: selectedColor });
    }
  };
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.card}>
          ...
          <Text style={styles.sectionTitle}>Choose Your Eye Color</Text>
          ...
          <View style={styles.colorGrid}>
            ...
            <TouchableOpacity
              ...
              onPress={() => handleColorSelect('brown')}
            >
              <Image
            ...
            <TouchableOpacity
              ...
              onPress={() => handleColorSelect('hazel')}
            >
              <Image
                source={require('../images/green_eye.jpeg')}
                style={styles.hairImage}
              />
              <View style={styles.colorLabel}>
                <Text style={styles.colorText}>Hazel</Text>
              </View>
            </TouchableOpacity>
            ...
            >
              <Image
                source={require('../images/hazel_eye.jpeg')}
                style={styles.hairImage}
              />
              <View style={styles.colorLabel}>
